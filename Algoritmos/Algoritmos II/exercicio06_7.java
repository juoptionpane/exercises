/*
Sub-Rotinas: Exemplo 7

Faça uma sub-rotina do tipo função que retorne 1 se o número inteiro passado por parâmetro for positivo 
e 0 se o número for negativo. Leia um número e passe para função e diga se o mesmo é positivo ou negativo.
*/
