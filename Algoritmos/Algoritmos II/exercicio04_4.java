...
public class exercicio04_4 {
    public static void main(String args[]) {
        ...
        JOptionPane.showMessageDialog(null, "f) Calcule e mostre os elementos que são maiores que a média"+ maiores_media_f);
        ...
        JOptionPane.showMessageDialog(null, "i) Mostre os elementos da diagonal principal"+ diag_principal);

        //j) Mostre os elementos do triângulo superior principal; (o número da linha é sempre menor que o da coluna)
        ...
        //k) Mostre os elementos do triângulo inferior principal;  (o número da linha é sempre maior que o da coluna)
        contador = 0;
        for (i=0; i<3; i++) {
            for (j=0; j<3; j++) {
                if (i > j) {
        ...
        //m) Mostre os elementos da diagonal secundária; (o número da linha somado ao número da coluna é sempre igual a 4, isto é, ordem + 1)
        contador = 0;
        int soma_ij = 0;
        for (i=0; i<3; i++) {
            for (j=0; j<3; j++) {
        ...
        //n) Mostre os elementos do triângulo superior secundário; (o número da linha somado ao número da coluna é sempre menor ou igual à ordem)
        contador = 0;
        soma_ij = 0;
        for (i=0; i<3; i++) {
            for (j=0; j<3; j++) {
        ...
        //o) Mostre os elementos do triângulo inferior secundário; (o número da linha somado ao número da coluna é sempre maior ou igual a ordem + 2)
        contador = 0;
        soma_ij = 0;
        for (i=0; i<3; i++) {
            for (j=0; j<3; j++) {
        ...
        //p) Calcule e mostre a Soma da diagonal secundária; (o número da linha somado ao número da coluna é sempre igual a 4, isto é, ordem + 1)
        int soma_diag_sec = 0;
        soma_ij = 0;
        for (i=0; i<3; i++) {
            for (j=0; j<3; j++) {
