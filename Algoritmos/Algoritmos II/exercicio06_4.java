/*
Sub-Rotinas: Exemplo 4

Faça um algoritmo para armazenar na memória as informações de N alunos, tais como: Nome / Idade / Sexo.
...
public class exercicio06_4 {
    ...
    //variaveis globais
    static int TAMANHO = 3; //escolher o número de alunos
    ...
    public static void opcao_1() {
        for (i=0; i<TAMANHO; i++) {
            ...
            A[i].sexo = JOptionPane.showInputDialog("Informe o sexo de " +A[i].nome+ ": (M) Masculino ou (F) Feminino").charAt(0);
        }
    }
